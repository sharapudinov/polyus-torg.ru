;(function() {
	...
	BX.Grid.Row.prototype = {
		...
		{
			var rows = this.parent.getRows().getRowsByParentId(this.getId());
		...
		{
			var rows = this.parent.getRows().getRowsByParentId(this.getId(), true);
		...
		isChildsLoaded: function()
		{
			...
			{
				this.childsLoaded = (BX.data(this.getNode(), 'child-loaded') == 'true');
			}
