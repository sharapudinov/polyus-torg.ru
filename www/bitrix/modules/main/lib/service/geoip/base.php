...
abstract class Base
{
	 ...
	 */
	public function isActive() { return $this->active == 'Y'; }
	 ...
	 */
	abstract public function getData($ip, $lang = '');
	...
	/**
	 * @return DataResult Geolocation information witch handler can return.
	 */
