...
BX.Kanban.Column.prototype =
{
	...
	setOptions: function(options)
	{
		...
		var boolOptions = ["canEdit", "canRemove", "canAddItem", "draggable", "droppable"];
	...
	makeDroppable: function()
	{
		...
		columnContainer.onbxdestdraghover = BX.delegate(this.onDragEnter, this);
		columnContainer.onbxdestdraghout = BX.delegate(this.onDragLeave, this);
		columnContainer.onbxdestdragfinish = BX.delegate(this.onDragDrop, this);

		columnContainer.onbxdestdragstop = BX.delegate(this.onItemDragEnd, this);

		jsDD.registerDest(columnContainer, 40);
	...
	{
		return this.draggable && this.isEditable();
	},
