...
$iblockCode = "elasto_gallery_".WIZARD_SITE_ID;
$iblockType = "content";
...
$arUserFields = array("UF_SHORT_DESC", "UF_PREVIEW");
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/gallery/index.php", array("ELASTO_GALLERY_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/gallery/.topchild.menu_ext.php", array("ELASTO_GALLERY_IBLOCK_ID" => $iblockID));?>